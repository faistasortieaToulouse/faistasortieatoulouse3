...
import { Zap, Film, Bell, Gamepad2, Database, RefreshCw, AlertCircle } from "lucide-react";
...
export default function MeetupSupPage() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center">
      <RefreshCw className="animate-spin text-red-600 mb-4" size={48} />
      <p className="text-slate-500 animate-pulse uppercase tracking-widest text-xs">Scan des flux en cours...</p>
    </div>
  );
  ...
  if (error) return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-xl font-bold mb-2">Connexion au Radar interrompue</h2>
      <button 
        onClick={loadStats}
        className="mt-4 px-6 py-2 bg-red-600 rounded-full font-bold uppercase text-xs hover:bg-red-700 transition-colors"
      >
